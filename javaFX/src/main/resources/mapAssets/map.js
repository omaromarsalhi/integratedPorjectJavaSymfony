                ...
                if (results[0]) {
                    ...
                    <div >
                        <h5 style=" color: black !important;
                                    font-weight: 300;
                                    font-size: 13px !important;margin: 0 !important;">` + placeName + `</h5>    
                       </div>
                        `;
...
function getCityFromGeocodeResponse(response) {
    ...
    for (const component of addressComponents) {
        if (component.types.includes('administrative_area_level_1')&&government==='') {
            government = component.long_name;
        }
        if (component.types.includes('administrative_area_level_2')&&municipality==='') {
